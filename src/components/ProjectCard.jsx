...
import {LucideIcon, Link2Icon} from 'lucide-react'
...
export const ProjectCard = ({project}) => {
  return (
    <Card className='group overflow-hidden relative'> 
       ...
       <div>
        <Badge className='uppercase text-sm font-medium mb-2 absolute top-4 left-5'>{project.category}
        </Badge>
        <h4 className='h4 mb-1'>
            {project.name}
        </h4>
        <p className='text-muted-foreground text-lg'>{project.descripcion}</p>
       </div>
        </Card>
  )
}
